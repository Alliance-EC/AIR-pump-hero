...
=======
    ...
    memset(char_friction_mode, '\0', sizeof(friction_mode));
    memset(char_rotate_mode, '\0', sizeof(rotate_mode));
    UICircleDraw(&Dirction_Chassis1, "CD1", Graphic_Operate_ADD, 9, Graphic_Color_Pink, 2, Center_Of_Dirction_X + Len_Dirction,
                 Center_Of_Dirction_Y + Len_Dirction, 100);
    UICircleDraw(&Dirction_Chassis2, "CD2", Graphic_Operate_ADD, 9, Graphic_Color_Pink, 2, Center_Of_Dirction_X - Len_Dirction,
                 Center_Of_Dirction_Y + Len_Dirction, 100);
    UICircleDraw(&Dirction_Chassis3, "CD3", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 2, Center_Of_Dirction_X + Len_Dirction,
                 Center_Of_Dirction_Y - Len_Dirction, 100);
    UICircleDraw(&Dirction_Chassis4, "CD4", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 2, Center_Of_Dirction_X - Len_Dirction,
                 Center_Of_Dirction_Y - Len_Dirction, 100);
...
<<<<<<< HEAD
        UICharDraw(&Load_moad, "006", Graphic_Operate_ADD, 9, Graphic_Color_Purplish_red, 30, 2, SCREEN_LENGTH / 2 + 400, SCREEN_WIDTH / 2 + 200, char_pitch);
        UICharRefresh(&referee_data_for_ui->referee_id, Load_moad);
    } else {
        sprintf(Load_moad.show_Data, "ONE SHOOT");
        UICharDraw(&Load_moad, "006", Graphic_Operate_ADD, 9, Graphic_Color_Orange, 30, 2, SCREEN_LENGTH / 2 + 400, SCREEN_WIDTH / 2 + 200, char_pitch);
        UICharRefresh(&referee_data_for_ui->referee_id, Load_moad);
    }
...
=======
    ...
    if (referee_data_for_ui->referee_id.Robot_Color == Robot_Red) {
        ...
        UICharDraw(&Robot1, "RB1", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 400, SCREEN_WIDTH - 400, char_pitch);
        UICharRefresh(&referee_data_for_ui->referee_id, Robot1);
        UICharDraw(&Robot2, "RB2", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 400, SCREEN_WIDTH - 440, char_pitch);
        UICharRefresh(&referee_data_for_ui->referee_id, Robot2);
        UICharDraw(&Robot3, "RB3", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 400, SCREEN_WIDTH - 480, char_pitch);
        UICharRefresh(&referee_data_for_ui->referee_id, Robot3);
        UICharDraw(&Robot4, "RB4", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 400, SCREEN_WIDTH - 520, char_pitch);
        UICharRefresh(&referee_data_for_ui->referee_id, Robot4);
        UICharDraw(&Robot5, "RB5", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 400, SCREEN_WIDTH - 560, char_pitch);
        UICharRefresh(&referee_data_for_ui->referee_id, Robot5);
        UICharDraw(&Robotsentry, "RB6", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 400, SCREEN_WIDTH - 600, char_pitch);
...
<<<<<<< HEAD
    // if (UI_last.Bullet_ready != UI_Now->Bullet_ready) {
    //     if (UI_Now->Bullet_ready == 1) {
...
=======
        ...
        UILineDraw(&Pitch_dirction, "PD3", Graphic_Operate_CHANGE, 8, Graphic_Color_Yellow, 2, Pitch_angle_X,
                   ...
                   Pitch_angle_Y + 40 + 60 * arm_sin_f32(UI_last.pitch_data * DEGREE_2_RAD));
        UIGraphRefresh(&referee_data_for_ui->referee_id, 1, Pitch_dirction);
        UILineDraw(&Dirction_forward, "CD5", Graphic_Operate_CHANGE, 8, Graphic_Color_Green, 2, Center_Of_Dirction_X,
...
=======
            UIIntDraw(&Robot1HP, "HP1", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 300, SCREEN_WIDTH - 400, UI_last.All_robot_HP.red_1_robot_HP);
            UIIntDraw(&Robot2HP, "HP2", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 300, SCREEN_WIDTH - 440, UI_last.All_robot_HP.red_2_robot_HP);
            UIIntDraw(&Robot3HP, "HP3", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 300, SCREEN_WIDTH - 480, UI_last.All_robot_HP.red_3_robot_HP);
            UIIntDraw(&Robot4HP, "HP4", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 300, SCREEN_WIDTH - 520, UI_last.All_robot_HP.red_4_robot_HP);
            UIIntDraw(&Robot5HP, "HP5", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 300, SCREEN_WIDTH - 560, UI_last.All_robot_HP.red_5_robot_HP);
            UIIntDraw(&RobotsentryHP, "HP6", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 300, SCREEN_WIDTH - 600, UI_last.All_robot_HP.red_7_robot_HP);
            UIGraphRefresh(&referee_data_for_ui->referee_id, 5, Robot1HP, Robot2HP, Robot3HP, Robot4HP, Robot5HP);
            UIGraphRefresh(&referee_data_for_ui->referee_id, 1, RobotsentryHP);
        } else {
            UIIntDraw(&Robot1HP, "HP1", Graphic_Operate_CHANGE, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 300, SCREEN_WIDTH - 400, UI_last.All_robot_HP.red_1_robot_HP);
            UIIntDraw(&Robot2HP, "HP2", Graphic_Operate_CHANGE, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 300, SCREEN_WIDTH - 440, UI_last.All_robot_HP.red_2_robot_HP);
            UIIntDraw(&Robot3HP, "HP3", Graphic_Operate_CHANGE, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 300, SCREEN_WIDTH - 480, UI_last.All_robot_HP.red_3_robot_HP);
            UIIntDraw(&Robot4HP, "HP4", Graphic_Operate_CHANGE, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 300, SCREEN_WIDTH - 520, UI_last.All_robot_HP.red_4_robot_HP);
            UIIntDraw(&Robot5HP, "HP5", Graphic_Operate_CHANGE, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 300, SCREEN_WIDTH - 560, UI_last.All_robot_HP.red_5_robot_HP);
            UIIntDraw(&RobotsentryHP, "HP6", Graphic_Operate_CHANGE, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 300, SCREEN_WIDTH - 600, UI_last.All_robot_HP.red_7_robot_HP);
>>>>>>> 82775a6cbbda179c12e42b923b2e54f64f9d7f72
            UIGraphRefresh(&referee_data_for_ui->referee_id, 5, Robot1HP, Robot2HP, Robot3HP, Robot4HP, Robot5HP);
            UIGraphRefresh(&referee_data_for_ui->referee_id, 1, RobotsentryHP);
        }
...
=======
            UIIntDraw(&Robot1HP, "HP1", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 100, SCREEN_WIDTH - 400, UI_last.All_robot_HP.blue_1_robot_HP);
            UIIntDraw(&Robot2HP, "HP2", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 100, SCREEN_WIDTH - 440, UI_last.All_robot_HP.blue_2_robot_HP);
            UIIntDraw(&Robot3HP, "HP3", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 100, SCREEN_WIDTH - 480, UI_last.All_robot_HP.blue_3_robot_HP);
            UIIntDraw(&Robot4HP, "HP4", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 100, SCREEN_WIDTH - 520, UI_last.All_robot_HP.blue_4_robot_HP);
            UIIntDraw(&Robot5HP, "HP5", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 100, SCREEN_WIDTH - 560, UI_last.All_robot_HP.blue_5_robot_HP);
            UIIntDraw(&RobotsentryHP, "HP6", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 100, SCREEN_WIDTH - 600, UI_last.All_robot_HP.blue_7_robot_HP);
            UIGraphRefresh(&referee_data_for_ui->referee_id, 5, Robot1HP, Robot2HP, Robot3HP, Robot4HP, Robot5HP);
            UIGraphRefresh(&referee_data_for_ui->referee_id, 1, RobotsentryHP);
        } else {
            UIIntDraw(&Robot1HP, "HP1", Graphic_Operate_CHANGE, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 100, SCREEN_WIDTH - 400, UI_last.All_robot_HP.blue_1_robot_HP);
            UIIntDraw(&Robot2HP, "HP2", Graphic_Operate_CHANGE, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 100, SCREEN_WIDTH - 440, UI_last.All_robot_HP.blue_2_robot_HP);
            UIIntDraw(&Robot3HP, "HP3", Graphic_Operate_CHANGE, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 100, SCREEN_WIDTH - 480, UI_last.All_robot_HP.blue_3_robot_HP);
            UIIntDraw(&Robot4HP, "HP4", Graphic_Operate_CHANGE, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 100, SCREEN_WIDTH - 520, UI_last.All_robot_HP.blue_4_robot_HP);
            UIIntDraw(&Robot5HP, "HP5", Graphic_Operate_CHANGE, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 100, SCREEN_WIDTH - 560, UI_last.All_robot_HP.blue_5_robot_HP);
            UIIntDraw(&RobotsentryHP, "HP6", Graphic_Operate_CHANGE, 9, Graphic_Color_Yellow, 10, 2, SCREEN_LENGTH - 100, SCREEN_WIDTH - 600, UI_last.All_robot_HP.blue_7_robot_HP);
>>>>>>> 82775a6cbbda179c12e42b923b2e54f64f9d7f72
            UIGraphRefresh(&referee_data_for_ui->referee_id, 5, Robot1HP, Robot2HP, Robot3HP, Robot4HP, Robot5HP);
            UIGraphRefresh(&referee_data_for_ui->referee_id, 1, RobotsentryHP);
        }
...
=======
    ...
    if (init_flag == 1) {
        ...
        UIGraphRefresh(&referee_data_for_ui->referee_id, 1, CAP_power);
        UIFloatDraw(&Pitch_angle, "pid", Graphic_Operate_ADD, 9, Graphic_Color_Yellow, 30, 1, 2, Pitch_angle_X - 30, Pitch_angle_Y + 40, UI_last.pitch_data);
