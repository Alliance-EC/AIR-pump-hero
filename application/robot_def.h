...
#define PRE_SPEED_UP 100 //每次增加的速度
// 陀螺仪校准数据，开启陀螺仪校准后可从INS中获取
#define BMI088_PRE_CALI_GYRO_X_OFFSET -0.00201896252
#define BMI088_PRE_CALI_GYRO_Y_OFFSET 0.000852902944
#define BMI088_PRE_CALI_GYRO_Z_OFFSET 0.00069176493
//陀螺仪默认环境温度
...
typedef struct
{
    ...
    // float real_power,pre_power;
    // int current,rpm_speed;
